...
🔺 ᴜᴘʟᴏᴀᴅ <a href="https://t.me/Ordinary_Bots/2">ʏᴛ-ᴅʟᴘ sᴜᴘᴘᴏʀᴛᴇᴅ ʟɪɴᴋs</a> ᴛᴏ ᴛᴇʟᴇɢʀᴀᴍ.
...
🔻 ʜᴏᴡ ᴛᴏ ᴜᴘʟᴏᴀᴅ ʏᴏᴜᴛᴜʙᴇ ʟɪɴᴋs <a href="https://t.me/Ordinary_Bots/4">ᴛᴜᴛᴏʀɪᴀʟ ᴠɪᴅᴇᴏ</a>
...
🌀 ᴄʜᴀɴɴᴇʟ : <a href="https://t.me/Ordinary_Bots">ＥＭＯＮ ＦＸ</a>
...
👲 ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href="https://t.me/Emonfx7">ＥＭＯＮ ＦＸ</a></b>
...
"""
    ...
    TECH_VJ_START_BUTTONS = InlineKeyboardMarkup(
        [[
            InlineKeyboardButton('💝 sᴜʙsᴄʀɪʙᴇ ᴍʏ ʏᴏᴜᴛᴜʙᴇ ᴄʜᴀɴɴᴇʟ', url='https://youtube.com/@Ordinary_Bots')
        ], [
            InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/Ordinary_Bots_Group'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/Ordinary_Bots')
        ], [
            InlineKeyboardButton('❓ ʜᴇʟᴘ', callback_data='help'),
            InlineKeyboardButton('🦊 ᴀʙᴏᴜᴛ', callback_data='about')
        ], [
            InlineKeyboardButton('🇮🇳 ғᴏʟʟᴏᴡ ᴍᴇ ᴏɴ ɪɴsᴛᴀɢʀᴀᴍ 💖', url='https://instagram.com/edit.emon.fx')
        ]]
    )
